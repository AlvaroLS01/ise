package com.comerzzia.bricodepot.instoreengine.rest.cliente.cajas.movimientos;
...
public class CajasMovimientosDTO {
	...
	public void setCodConceptoMovOrigen(String codConceptoMovOrigen) {
		this.codConceptoMovOrigen = codConceptoMovOrigen;
	}
	...
	public void setCodCajaOrigen(String codCajaOrigen) {
		this.codCajaOrigen = codCajaOrigen;
	}
	...
	public void setCodConceptoMovDestino(String codConceptoMovDestino) {
		this.codConceptoMovDestino = codConceptoMovDestino;
	}
